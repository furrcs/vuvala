...
class VenvManagerGUI:
    ...
    def setup_env_tab(self, parent):
        ...
        self.env_info_label = ttk.Label(parent, text="Выберите окружение для просмотра информации", foreground="gray")
    ...
    def delete_venv(self):
        ...
        if messagebox.askyesno("Подтверждение", f"Вы уверены, что хотите удалить окружение '{name}'?\nЭто действие нельзя отменить!"):
